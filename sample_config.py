...
class Config(object):
    ...
    UPDATE_CHANNEL = os.environ.get("UPDATE_CHANNEL", "Cortana_Updates")
    ...
    DEF_WATER_MARK_FILE = ""
    # Sql Database url
    DB_URI = os.environ.get("DATABASE_URL", "postgres://vuounpax:vWsj7Hrsk0mtGmegsxnQzthyFApKd-zu@chunee.db.elephantsql.com/vuounpax")
